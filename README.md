...
<!-- ![React Native Logo](src/images/react-native.png) -->

<p align="center">
  <img src="src/images/react-native.png">
</p>
...
P/s: Bài viết chủ yếu dựa trên tài liệu chính thống của React-Native phiên bản 0.61 tại <https://facebook.github.io/react-native/docs/getting-started> kết hợp với sự hiểu biết cá nhân của mình vì vậy nếu có sai sót, anh em cứ góp ý để mình sửa đổi nhé.
...
- **modules** là thư mục chứa các module do mình định nghĩa hoặc tùy biến lại. Trong đó bao gồm:
  ...
  About me: <https://fb.me/thuy.ly.73997>
